...
], function (jQuery, Filter, JSONModel, MessageBox, MessageToast, History, Controller) {
    "use strict";

    var MainController = Controller.extend("capgemini.CapgeminiPOD.controller.Main", {
