sap.ui.define([
	...
	return Controller.extend("capgemini.CapgeminiPOD.controller.Main", {
		onInit : function () {
		...
		initSampleDataModel : function() {
			...
			jQuery.ajax(jQuery.sap.getModulePath("capgemini.CapgeminiPOD", "model/products.json"), {
				dataType: "json",
		...
		onOpenDialog: function (oEvent) {
			...
			// instantiate dialog
			if (!this._dialog) {
                            this._dialog = sap.ui.xmlfragment("capgemini.CapgeminiPOD.view.BusyDialog", this);
