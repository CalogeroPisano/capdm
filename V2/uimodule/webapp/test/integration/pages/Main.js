sap.ui.require([
  ...
  var sViewName = "com.capgemini.DMUsecase.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.capgemini.DMUsecase"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.capgemini.DMUsecase"
            });
        }
      }
